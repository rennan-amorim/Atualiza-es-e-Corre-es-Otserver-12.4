local destination = {
	...
	[3128] = {position = Position(33000, 31870, 13), storageValue = 1, needCrystal = false},
	[3129] = {position = Position(32795, 31762, 10), storageValue = 1, needCrystal = false},
	[3130] = {position = Position(32864, 31844, 11), storageValue = 1, needCrystal = false},
	[3131] = {position = Position(32803, 31746, 10), storageValue = 1, needCrystal = false},
	[3132] = {position = Position(32988, 31862, 9), storageValue = 27, needCrystal = false}, -- gnomebase alpha
	[3133] = {position = Position(32798, 31783, 10), storageValue = 27, needCrystal = false}, -- city
	[3134] = {position = Position(32959, 31953, 9), storageValue = 27, needCrystal = false}, -- golems
	[3135] = {position = Position(33001, 31915, 9), storageValue = 27, needCrystal = false}, -- back from golems
	[3136] = {position = Position(32904, 31894, 13), storageValue = 27, needCrystal = false}, -- vulcongras
	[3137] = {position = Position(32979, 31907, 9), storageValue = 27, needCrystal = false}, -- back from vulcongras
