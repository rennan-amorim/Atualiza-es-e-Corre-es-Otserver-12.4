	...
	if item.itemid == 9825 then
		...
		for y = 32868, 32872 do
			...
			if playerTile and playerTile:isPlayer() then
				if playerTile:getStorageValue(Storage.ForgottenKnowledge.LloydTimer) >= 1 then
		...
		for y = 32868, 32872 do
			...
			if playerTile and playerTile:isPlayer() then
				if verificarStorage < 1 then
					...
					playerTile:setStorageValue(Storage.ForgottenKnowledge.LloydTimer, os.time() + 6 * 3600)
				end
